...
module.exports = {
    up: async (queryInterface: QueryInterface) => {
        ...
        // await queryInterface.addIndex('audit_logs', ['entity_type', 'entity_id']); // Redundant if individual indexes cover it usually, but specific composite good for EXACT history fetch
